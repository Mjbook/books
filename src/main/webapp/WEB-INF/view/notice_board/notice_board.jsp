...
<article id="suvcon">
		...
		<div class="rightcon">
			<h3>공지사항</h3>
			<form name="write" action="bbsWrite.do">
			<table class="tableRegister mt10">
					<tr>	
						<th scope="row" style="15%">제목</th>
						<td style="width:85%"><input type="text" name="title" class="sw300"></td>
				   </tr>
				   <tr>
					...
					<tr>
						...
						<tr>
						<th scope="row">등록자 </th>
						<td><input type="text" name="writer" class="sw100" value="통합관리자"></td>
					</tr>
					<tr>
						<th scope="row">내용</th>
						<td><textarea name="content" style="height:100px;width:96%">에디터 삽입</textarea></td>
					</tr>
					<tr>
